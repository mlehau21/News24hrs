...
<div class="single_category wow fadeInDown">
            <h2> <span class="bold_line"><span></span></span> <span class="solid_line"></span> <a class="title_text" href="#"><?php echo $row['CategoryName']?></a> </h2>
            ...
            <div class="business_category_right wow fadeInDown">
			  ...
			  ?>
                <li>
                  <div class="media wow fadeInDown"> <a class="media-left" href="?page=chi-tiet-bai-viet&&ArticleID=<?php echo $row3['ArticleID'] ?>&&CategoryID=<?php echo $row3['CategoryID'] ?> "><img src="upload/<?php echo $row3['Img']?>" alt=""></a>
                    <div class="media-body">
                      <h4 class="media-heading "><a href="?page=chi-tiet-bai-viet&&ArticleID=<?php echo $row3['ArticleID'] ?>&&CategoryID=<?php echo $row3['CategoryID'] ?> "><div class="col-md-12"><?php echo $row3['Title']?></div> </a></h4>
